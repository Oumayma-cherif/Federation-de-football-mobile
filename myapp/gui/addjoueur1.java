...
public class addjoueur1 extends Form {
    ...
    public addjoueur1() {
        ...
        btnValider.addActionListener((e) -> {
            ...
            joueur r = new joueur(Integer.parseInt(age.getText()), Integer.parseInt(nbm.getText()), Integer.parseInt(nba.getText()), nom.getText(), prenom.getText(), poste.getText(), nationalite.getText(), fileNameInServer);
            System.out.println("data evenement ==" + r);
            servicejoueur.getInstance().addjoueur1(r);

            //getToolbar().addMaterialCommandToLeftBar("", FontImage.MATERIAL_ARROW_BACK, e-> previous.showBack());
        });
        addAll(age, nbm, nba, nom,prenom,poste,nationalite,imgBtn, btnValider);
