...
try {
    ...
    public ArrayList<joueur> getAlljoueur() {
        String url = Statics.BASE_URL + "/viewj";
        req.setUrl(url);
        req.setPost(false);
    ...
    public boolean Delete(int cin) {
        String url = Statics.BASE_URL + "/deletejoueur?cin=" + cin;
    ...
    public void addjoueur1(joueur r) {
        String url = Statics.BASE_URL + "/addJoueur1?nom=" + r.getNom() +"&prenom="+ r.getprenom()+ "&poste="+ r.getposte()+ "&nba=" + r.getnba() +"&nbm="+ r.getnbm() +"&nationalite=" + r.getnationalite() +"&age=" + r.getage() ;
    ...
    public boolean modifierJoueur(joueur event) {
        String url = Statics.BASE_URL + "/updateJoueur/" + event.getcin() + "?nom=" + event.getNom() + "&poste=" + event.getposte();
        req.setUrl(url);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
