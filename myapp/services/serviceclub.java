...
public class serviceclub {
    ...
    public ArrayList<club> parseCat(String jsonText) {
        try {
            ...
            for (Map<String, Object> obj : list) {
                ...
                try {
                    e.setNomc(obj.get("nomc").toString());
                } catch (Exception e2) {
    ...
    public boolean Delete(int id) {
        String url = Statics.BASE_URL + "/deleteclub?id=" + id;
    ...
    public void addTournoi(club c) {
        String url = Statics.BASE_URL + "/addClub?nomc=" + c.getNomc() + "&logo=" + c.getLogo() + "&descr="
    ...
    public boolean modifierClub(club event) {
        String url = Statics.BASE_URL + "/updateClub/" + event.getId() + "?nomc=" + event.getNomc() + "&descr=" + event.getDescr()
