...
public class ServiceTournoi {
    ...
    public boolean deleteTournoi(int t) {
       ...
       String url = Statics.BASE_URL + "deletebj?id="+t;
    ...
    public boolean addTournoi(Tournoi t) {
       ...
       String url = Statics.BASE_URL + "addTournoij?nomt=" + t.getNomt()+"&logo=" + t.getLogo() + "&dated=" + t.getDated()+"&datef=" + t.getDatef()+"&typet=" + t.getTypet()+"&nbrc=" + t.getNbrc();
       //String url = Statics.BASE_URL + "addTournoij";
       req.setUrl(url);
      req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
    ...
    public boolean updateTournoi(Tournoi t) {
       ...
       String url = Statics.BASE_URL + "updateTournoij?&id="+t.getId()+"&nomt=" + t.getNomt()+"&logo=" + t.getLogo() + "&dated=" + t.getDated()+"&datef=" + t.getDatef()+"&typet=" + t.getTypet()+"&nbrc=" + t.getNbrc();
       //String url = Statics.BASE_URL + "addTournoij";
       req.setUrl(url);
      req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
    ...
    public ArrayList<Tournoi> getAll(){
        ...
        String url = Statics.BASE_URL +"/viewbj";
...
public Tournoi getN(int t) {
        String url = Statics.BASE_URL + "/viewbj?nom=" + t;
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
