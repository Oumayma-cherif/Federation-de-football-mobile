...
public class ServiceArbitre {
    ...
    public boolean addArbitre(Arbitre t) {
        ...
        String url = Statics.BASE_URL + "/addArbitrej?nomA=" + t.getNomA() + "&image=" + t.getImage() + "&nbe=" + t.getNbe() + "&descrp=" + t.getDescrp();
    ...
    public ArrayList<Arbitre> getAll() {
        ...
        String url = Statics.BASE_URL + "/viewAj";
    ...
    public boolean Delete(int id) {
        String url = Statics.BASE_URL + "/deleteArbitree/" + id;
    ...
    public boolean ModifierA(Arbitre arbitre) {
           ...
           String url = Statics.BASE_URL +"/updateArbitreJSON/"+arbitre.getId()+"?nomA="+arbitre.getNomA()+"&nbe="+arbitre.getNbe()+"&descrp="+arbitre.getDescrp()+"&image="+arbitre.getImage();
