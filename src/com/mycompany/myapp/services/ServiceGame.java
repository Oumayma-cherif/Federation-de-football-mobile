...
public class ServiceGame {
    ...
    public static ServiceGame getInstance1() {
     ...
     public boolean addGame(Game t) {
       ...
       String url = Statics.BASE_URL + "/addGame?idt=" + t.getTournoi().getId()+"&idc1=" + t.getClub1().getId()+"&r1=" + t.getR1() + "&r2=" + t.getR2()+"&idc2=" + t.getClub2().getId()+"&idar=" + t.getArbitre().getId()+"&ids=" + t.getStade().getId()+"&dated=" + t.getDeted();
      ...
      public boolean deleteGame(int t) {
       ...
       String url = Statics.BASE_URL + "/deleteG?id="+t;
       //String url = Statics.BASE_URL + "addTournoij";
       req.setUrl(url);
      req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
    ...
    public ArrayList<Game> getAll(){
        ...
        String url = Statics.BASE_URL +"/viewG";
    ...
    public boolean ModifierG(Game t) {
           ...
           String url = Statics.BASE_URL +"/updateGameeJSON/"+t.getId()+"?idt=" + t.getTournoi().getId()+"&idc1=" + t.getClub1().getId()+"&r1=" + t.getR1() + "&r2=" + t.getR2()+"&idc2=" + t.getClub2().getId()+"&idar=" + t.getArbitre().getId()+"&ids=" + t.getStade().getId()+"&dated=" + t.getDeted();
