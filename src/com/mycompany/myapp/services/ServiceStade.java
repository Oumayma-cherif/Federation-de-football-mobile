...
public class ServiceStade{
    ...
    public boolean addStade(Stade t) {
        ...
        String url = Statics.BASE_URL + "/addStadesj?noms=" + t.getNoms() + "&nbrP=" + t.getNbrP() + "&lieu=" + t.getLieu() + "&etat=" + t.getEtat()+ "&photo=" + t.getPhoto();
    ...
    public ArrayList<Stade> affichStade(String jsontext) {
     ...
     public ArrayList<Stade> getAll(){
        ...
        String url = Statics.BASE_URL +"/viewSj";
        Stade t=new Stade();
        req.setUrl(url);
     req.setPost(false);
         req.addResponseListener(new ActionListener<NetworkEvent>() {
      ...
      public boolean  Delete(int id){
       String url = Statics.BASE_URL + "/deleteStadee/" +id;
      ...
      public List<String>fillintot()
    {
      ...
      //  System.out.println(tournoiss);
       ...
       public boolean  ModifierS(Stade arbitre){
                    String url = Statics.BASE_URL +"/updateGameJSON/"+arbitre.getId()+"?noms="+arbitre.getNoms()+"&nbrP="+arbitre.getNbrP()+"&lieu="+arbitre.getLieu()+"&etat="+arbitre.getEtat()+"&photo="+arbitre.getPhoto();
          req.setUrl(url);
             req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
